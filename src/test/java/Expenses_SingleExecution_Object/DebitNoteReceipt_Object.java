	...
	public void CreateDebitNoteReceipt() throws Throwable {
		...
		for(int i=1;i<=DbtRec_Rows;i++) {
	        ...
	        for (int k = 0; k < DbtIDs.size(); k++) {
	            ...
	            System.out.println("4. Expenses Debit Note Receipt: "+ReceiptID+" Received amount is: "+ReceiptAmount+" INR.. from Debite Note ID: "+debitNote.DbtNoteID);
	           }
		   }
		catch (Exception e) {
