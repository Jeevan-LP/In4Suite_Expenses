...
public class Advance_Object extends BaseClass {
	...
	public Advance_Object(WebDriver BrowserDriver, WorkOrder_Object WoObject){
	...
	@FindBy(xpath = "//span[@id='dgPayment_ctl02_lblAmountPaid']")
	private WebElement AdvancePaidAmount;
	public String getAdvancePaidAmount() {
		return AdvancePaidAmount.getText();
	}
	
	@FindBy(xpath = "//span[@id='lblGrossAmount']")
	private WebElement AdvanceGrossAmount;
	public String getAdvanceGrossAmount() {
		return AdvanceGrossAmount.getText();
	}
	...
	public void CreateAdvance() throws Throwable {
		...
		for(int i=1;i<=Advance_Rows;i++) {
            ...
            AppInd.jsScrollToBottom(BrowserDriver);
            Thread.sleep(1500);
            String paidAmount = getAdvancePaidAmount();
            System.out.println("2. Expenses Advance Request Id: "+AdvanceID+" Paid amount is: "+paidAmount+" INR"+" for "+WoObject.WODisplayNo);
